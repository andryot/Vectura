  ...
  factory BackendFailure.fromStatusCode(int statusCode) {
    switch (statusCode) {
      ...
      case HttpStatus.requestTimeout:
        return const RequestTimeoutBackendFailure();
      default:
...
class PreconditionFailedBackendFailure extends BackendFailure {
  const PreconditionFailedBackendFailure();
}

class RequestTimeoutBackendFailure extends BackendFailure {
  const RequestTimeoutBackendFailure();
}
